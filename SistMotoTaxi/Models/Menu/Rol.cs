    ...
    public class Rol
    {
        ...
        public static List<Roles> ObtenerRoles()
        {
            ...
            try
            {
                ...
                var registros = Dapper.SqlMapper.Query<Roles>(cnn, "sp_get_rol", null, commandType: CommandType.StoredProcedure);
        ...
        public static SelectList ObtenerRol(int idSelected = 0)
        {
            ...
            try
            {
                ...
                var result = Dapper.SqlMapper.Query<Roles>(cnn, "SP_get_Rol", null, commandType: CommandType.StoredProcedure);
